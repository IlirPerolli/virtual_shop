...
@section('title')
    <title>Bufi &#8226; Eksploro kompani </title>
@endsection
@section('styles')
    <style>body{
            background: #F9F9FF;
...
@section('content')
    ...
    <div class="whole-wrap" style="margin-top: 120px; margin-bottom: 120px;">
        <div class="container">
            ...
            <h3 class="text-center" style="margin-bottom: 50px;">Eksploro Kompani</h3>
            <div class="row">
                @if(count($users)>0)
                    ...
                    @endforeach
                @else
                    <h4 style="margin-bottom: 20px; color:red; margin:auto" class="text-center">Nuk u gjet asnj&euml; kompani</h4>
                @endif
            </div>
